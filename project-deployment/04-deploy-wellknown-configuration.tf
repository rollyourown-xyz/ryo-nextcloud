...
module "deploy-nextcloud-wellknown-configuration" {
  ...
  wellknown_redirect_rules = {
    ...
    nextcloud-carddav = {
      ...
      wellknown_redirect_url = join("", [ "https://", local.project_domain_name, "/remote.php/dav" ])
    },
    ...
    #   wellknown_redirect_url = join("", [ "https://", local.project_domain_name, "/.well-known/nodeinfo" ])
    # },
    
    # nextcloud-webfinger = {
    #   wellknown_domain       = local.project_nextcloud_domain_name,
    #   wellknown_path         = "/.well-known/nodeinfo",
    #   wellknown_redirect_url = join("", [ "https://", local.project_domain_name, "/index.php/.well-known/webfinger" ])
    # }
  }
}
